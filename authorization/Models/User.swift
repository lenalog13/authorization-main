...
struct Person {
    ...
    static func getPerson() -> Person {
        Person(name: "Elena", surname: "Loginova",
                       gender: .female,
                       ...
                       hobby:
                           [("Баскетбол🏀", "Люблю командные виды спорта. Начала играть в 6 классе. В старших классах играла за сборную города. Сейчас иногда просто могу покидать мяч во дворе"),
                            ...
                            ("Путешествия✈️", "Любовь к различным поезкам проявилась еще в начальной школе. В 10 классе, поехала в Германию по обмену. В ковидные времена ездила по разным городам Росии. В прошлом году получилось посетить Тайланд. Еще много мест, в которых хочется побывать")
                       ])
    }
